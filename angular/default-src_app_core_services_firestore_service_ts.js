"use strict";
(self["webpackChunkBalacoClient"] = self["webpackChunkBalacoClient"] || []).push([["default-src_app_core_services_firestore_service_ts"],{
...
/* harmony import */ var _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/webchannel-wrapper */ 41726);
...
const N = new _firebase_logger__WEBPACK_IMPORTED_MODULE_3__.Logger("@firebase/firestore"); // Helper methods are needed because variables can't be exported as read/write
...
class Q extends _firebase_util__WEBPACK_IMPORTED_MODULE_4__.FirebaseError {
  /** @hideconstructor */
  constructor(
  /**
...
class J {
  ...
  start(t, e) {
    ...
    const r = () => {
      const e = i;
      t.enqueueRetryable( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
function _bt() {
  _bt = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
...
class Vt {
  ...
  constructor(t, e, n) {
    ...
    12.2 === Vt.v((0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getUA)()) && F("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this2.db || (M("SimpleDb", "Opening database:", _this2.name), _this2.db = yield new Promise((e, n) => {
        ...
        s.onsuccess = t => {
          ...
          _this2.P.O(e, s.transaction, t.oldVersion, _this2.version).next(() => {
            M("SimpleDb", "Database upgrade to version " + _this2.version + " complete");
          });
        };
      })), _this2.M && (_this2.db.onversionchange = t => _this2.M(t)), _this2.db;
    })();
  }
  ...
  runTransaction(t, e, n, s) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (;;) {
        ...
        try {
          _this3.db = yield _this3.k(t);
          const e = vt.open(_this3.db, t, i ? "readonly" : "readwrite", n),
                r = s(e).next(t => (e.R(), t)).catch(t => ( // Abort the transaction if there was an error.
          e.abort(t), Pt.reject(t))).toPromise(); // As noted above, errors are propagated by aborting the transaction. So
          ...
          if (M("SimpleDb", "Transaction failed with error:", e.message, "Retrying:", n), _this3.close(), !n) return Promise.reject(e);
        }
      }
    })();
  }
...
function Ot(t) {
  const e = Vt.v((0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getUA)());
...
class Mt {
  ...
  Z(t) {
    ...
    M("IndexBackiller", `Scheduled in ${t}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill"
    /* IndexBackfill */
    , t, /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this4.task = null;

      try {
        M("IndexBackiller", `Documents written: ${yield _this4.X.tt()}`);
      } catch (t) {
        Ct(t) ? M("IndexBackiller", "Ignoring IndexedDB error during index backfill: ", t) : yield bt(t);
      }
...
class Ft {
  ...
  tt(t = 50) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this5.persistence.runTransaction("Backfill Indexes", "readwrite-primary", e => _this5.et(e, t));
    })();
  }
  ...
  et(t, e) {
    ...
    return Pt.doWhile(() => !0 === i && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t).next(e => {
      if (null !== e && !n.has(e)) return M("IndexBackiller", `Processing collection: ${e}`), this.nt(t, e, s).next(t => {
        s -= t, n.add(e);
      });
      i = !1;
    })).next(() => e - s);
  ...
  nt(t, e, n) {
    ...
    return this.localStore.indexManager.getMinOffsetFromCollectionGroup(t, e).next(s => this.localStore.localDocuments.getNextDocuments(t, e, s, n).next(n => {
      const i = n.changes;
      return this.localStore.indexManager.updateIndexEntries(t, i).next(() => this.st(s, n)).next(n => (M("IndexBackiller", `Updating offset: ${n}`), this.localStore.indexManager.updateCollectionGroup(t, e, n))).next(() => i.size);
    }));
  }
...
function ge(t) {
  ...
  }(t.timestampValue) : "stringValue" in t ? t.stringValue : "bytesValue" in t ? te(t.bytesValue).toBase64() : "referenceValue" in t ? (n = t.referenceValue, dt.fromName(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function (t) {
    let e = "[",
        n = !0;
...
function Oe(t) {
  ...
  if (null === e.ut) {
    ...
    }(t)).join(","), oe(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", t += e.startAt.inclusive ? "b:" : "a:", t += e.startAt.position.map(t => me(t)).join(",")), e.endAt && (t += "|ub:", t += e.endAt.inclusive ? "a:" : "b:", t += e.endAt.position.map(t => me(t)).join(",")), e.ut = t;
  }
...
function Me(t) {
  ...
  }).join(", ")}]`), oe(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map(t => function (t) {
    return `${t.field.canonicalString()} (${t.dir})`;
  }(t)).join(", ")}]`), t.startAt && (e += ", startAt: ", e += t.startAt.inclusive ? "b:" : "a:", e += t.startAt.position.map(t => me(t)).join(",")), t.endAt && (e += ", endAt: ", e += t.endAt.inclusive ? "a:" : "b:", e += t.endAt.position.map(t => me(t)).join(",")), `Target(${e})`;
}
...
function Fe(t, e) {
  ...
  for (let i = 0; i < t.filters.length; i++) if (n = t.filters[i], s = e.filters[i], n.op !== s.op || !n.field.isEqual(s.field) || !fe(n.value, s.value)) return !1;
...
function hn(t) {
  ...
  if (null === e.lt) {
    ...
    if (null !== t && null === n) // In order to implicitly add key ordering, we must also add the
      ...
      t.isKeyField() || e.lt.push(new Xe(t)), e.lt.push(new Xe(ft.keyField(), "asc"
      /* ASCENDING */
      ));else {
      let t = !1;
...
function ln(t) {
  ...
  === e.limitType) e.ft = ke(e.path, e.collectionGroup, hn(e), e.filters, e.limit, e.startAt, e.endAt);else {
    ...
    const n = e.endAt ? new Ye(e.endAt.position, e.endAt.inclusive) : null,
...
function qn(t, e, n) {
  t instanceof jn ? function (t, e, n) {
    ...
    const s = Hn(t.fieldTransforms, e, n.transformResults),
          i = e.data;
...
class Rs {
  ...
  Yt(t) {
    ...
    let n = ws(); // We extract the set of limbo-only document updates as the GC logic
...
function Bs(t) {
  const e = Os(t); // In v1beta1 queries for collections at the root did not have a trailing
...
function Qs(t, e) {
  ...
  if ("targetChange" in e) {
    ...
    */
    ...
    const i = Fs(t, s.document.name),
          r = Ns(s.document.updateTime),
          o = new De({
      mapValue: {
    ...
    s.document;
    const i = Fs(t, s.document),
          r = s.readTime ? Ns(s.readTime) : ct.min(),
          o = xe.newNoDocument(i, r),
...
const wi = {},
      ...
      Ni = xi,
      ki = [...Ni, "indexConfiguration", "indexState", "indexEntries"];
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
class Fi {
  ...
  applyToLocalView(t, e) {
    ...
    for (const n of this.baseMutations) n.key.isEqual(t.key) && (e = Kn(n, t, e, this.localWriteTime)); // Second, apply all user-provided mutations.
...
function qi(t, e) {
  ...
  if (e.document) n = Ks(t.ne, e.document, !!e.hasCommittedMutations);else if (e.noDocument) {
    const t = dt.fromSegments(e.noDocument.path),
    ...
    {
      const t = dt.fromSegments(e.unknownDocument.path),
            s = ji(e.unknownDocument.version);
...
function Wi(t, e) {
  const n = (e.baseMutations || []).map(e => Ws(t.ne, e)); // Squash old transform mutations into existing patch or set mutations.
  ...
  const s = e.mutations.map(e => Ws(t.ne, e)),
...
class cr {
  ...
  be(t) {
    for (const e of t) {
      ...
      if (t < 128) this.Ie(t);else if (t < 2048) this.Ie(960 | t >>> 6), this.Ie(128 | 63 & t);else if (e < "\ud800" || "\udbff" < e) this.Ie(480 | t >>> 12), this.Ie(128 | 63 & t >>> 6), this.Ie(128 | 63 & t);else {
...
class wr {
  ...
  Ge(t) {
    ...
    for (; s < n.length && this.Qe(n[s]); ++s); // If we already have processed all segments, all segments are used to serve
...
class pr {
          ...
          */
          (r, i),
            ...
            for (const i of mt(e)) {
              const e = 0
              /* ASCENDING */
              === i.kind ? Le(t, i.fieldPath, t.startAt) : Ue(t, i.fieldPath, t.startAt);
          ...
          */
          (r, i),
            ...
            for (const i of mt(e)) {
              const e = 0
              /* ASCENDING */
              === i.kind ? Ue(t, i.fieldPath, t.endAt) : Le(t, i.fieldPath, t.endAt);
              n.push(e.value), s && (s = e.inclusive);
            }
            ...
            return new Ye(n, s);
                ...
                f = this.Ze(i, r, h),
                d = this.tn(i, r, c),
                _ = this.en(i.indexId, u, l, a.inclusive, f, h.inclusive, d);
  ...
  en(t, e, n, s, i, r, o) {
    ...
    for (let h = 0; h < u; ++h) {
      const u = e ? this.nn(e[h / c]) : yr,
            l = this.sn(t, u, n[h % c], s),
            f = this.rn(t, u, i[h % c], r),
            d = o.map(e => this.sn(t, u, e,
      /* inclusive= */
      !0));
  ...
  cn(t, e) {
    return !!t.filters.find(t => t instanceof qe && t.field.isEqual(e) && ("in"
    /* IN */
    === t.op || "not-in"
    /* NOT_IN */
    === t.op));
  ...
  getFieldIndexes(t, e) {
    ...
    return (e ? n.K("collectionGroupIndex", IDBKeyRange.bound(e, e)) : n.K()).next(t => {
      ...
      return Pt.forEach(t, t => s.get([t.indexId, this.uid]).next(n => {
        e.push(function (t, e) {
          const n = e ? new yt(e.sequenceNumber, new Tt(ji(e.readTime), new dt(li(e.documentKey)), e.largestBatchId)) : yt.empty(),
                s = t.fields.map(([t, e]) => new gt(ft.fromServerFormat(t), e));
  ...
  updateIndexEntries(t, e) {
    ...
    return Pt.forEach(e, (e, s) => {
      ...
      return (i ? Pt.resolve(i) : this.getFieldIndexes(t, e.collectionGroup)).next(i => (n.set(e.collectionGroup, i), Pt.forEach(i, n => this.fn(t, e, n).next(e => {
        const i = this.dn(s, n);
  ...
  createRange(t, e, n) {
    ...
    for (const i of n) {
      ...
      if (0 === n) // `notInValue` is the lower bound. We therefore need to raise the bound
        // to the next value.
        s[0] = t.Le();else if (n > 0 && r < 0) // `notInValue` is in the middle of the range
        s.push(i), s.push(i.Le());else if (r > 0) // `notInValue` (and all following values) are out of the range
        break;
    }
  ...
  addMutationBatch(t, e, n, s) {
    ...
    return r.add({}).next(o => {
      ...
      const u = new Fi(o, e, n, s),
            c = function (t, e, n) {
        const s = n.baseMutations.map(e => js(t.ne, e)),
              i = n.mutations.map(e => js(t.ne, e));
        return {
          userId: e,
          batchId: n.batchId,
...
class Or {
  ...
  removeTargetData(t, e) {
    return this.removeMatchingKeysForTargetId(t, e.targetId).next(() => Mr(t).delete(e.targetId)).next(() => this.bn(t)).next(e => (U(e.targetCount > 0), e.targetCount -= 1, this.Pn(t, e)));
  }
  /**
  ...
  getTargetData(t, e) {
    ...
    return Mr(t).J({
      ...
      const r = zi(n); // After finding a potential match, check that the target is
...
class Ur {
  ...
  kn(t) {
    ...
    M("LruGarbageCollector", `Garbage collection scheduled in ${t}ms`), this.Nn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection"
    ...
    , t, /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        ...
        Ct(t) ? M("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : yield bt(t);
      }
...
class jr {
  ...
  Qn(t, e, n) {
    ...
    const i = IDBKeyRange.bound(Yr(s.first()), Yr(s.last())),
          r = s.getIterator();
    let o = r.getNext();
    return Jr(t).J({
      index: "documentKeyIndex",
      ...
      const i = dt.fromSegments([...e.prefixPath, e.collectionGroup, e.documentId]); // Go through keys not found in cache.
  ...
  getAllFromCollection(t, e, n) {
    const s = [e.popLast().toArray(), e.lastSegment(), Gi(n.readTime), n.documentKey.path.isEmpty() ? "" : n.documentKey.path.lastSegment()],
  ...
  Kn(t, e) {
    if (e) {
      const t = qi(this.wt, e); // Whether the document is a sentinel removal and should only be used in the
...
class zr extends Qr {
   ...
   */
  constructor(t, e) {
    super(), this.zn = t, this.trackRemovals = e, // A map of document sizes and read times prior to applying the changes in
    // this buffer.
  ...
  applyChanges(t) {
    const e = [];
    let n = 0,
        s = new Qt((t, e) => it(t.canonicalString(), e.canonicalString()));
...
function Zr(t, e) {
  ...
  for (let t = 0; t < n.length - 2 && t < s.length - 2; ++t) if (i = it(n[t], s[t]), i) return i;
...
class eo {
  ...
  getDocument(t, e) {
    let n = null;
    return this.documentOverlayCache.getOverlay(t, e).next(s => (n = s, this.getBaseDocument(t, e, n))).next(t => (null !== n && Kn(n.mutation, t, zt.empty(), ut.now()), t));
  }
  /**
  ...
  recalculateAndSaveOverlays(t, e) {
    const n = fs(); // A reverse lookup map from batch id to the documents within that batch.

    let s = new qt((t, e) => t - e),
        i = ws();
  ...
  getNextDocuments(t, e, n, s) {
    return this.remoteDocumentCache.getAllFromCollectionGroup(t, e, n, s).next(i => {
      const r = s - i.size > 0 ? this.documentOverlayCache.getOverlaysForCollectionGroup(t, e, n.largestBatchId, s - i.size) : Pt.resolve(hs()); // The callsite will use the largest batch ID together with the latest read time to create
      ...
      let o = -1,
          u = i;
      return r.next(e => Pt.forEach(e, (e, n) => (o < n.largestBatchId && (o = n.largestBatchId), i.get(e) ? Pt.resolve() : this.getBaseDocument(t, e, n).next(t => {
        u = u.insert(e, t);
...
class oo {
  ...
  getAllMutationBatchesAffectingQuery(t, e) {
    ...
    const r = new ro(new dt(i), 0); // Find unique batchIDs referenced by all documents potentially matching the
    // query.
  ...
  In(t) {// No-op since the memory mutation queue does not maintain a separate cache.
  }
...
class uo {
  ...
  getAllFromCollection(t, e, n) {
    let s = os(); // Documents are ordered by key, so we can use a prefix scan to narrow down
...
class _o {
  ...
  O(t, e, n, s) {
    ...
    */
    ...
    }(t)).next(() => this.Gs(t, i)).next(() => t.deleteObjectStore("remoteDocuments"))), n < 14 && s >= 14 && (r = r.next(() => this.Qs(t, i))), n < 15 && s >= 15 && (r = r.next(() => function (t) {
    ...
    return n.K().next(t => {
      ...
      return t.forEach(t => {
        ...
        const r = new C(n),
              ...
              c = Sr.se(r, this.wt, u, i.referenceDelegate);
...
class go {
  ...
  ci(t) {
    ...
    return this.ti = /*#__PURE__*/function () {
      var _ref4 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
  ...
  setDatabaseDeletedListener(t) {
    this.ni.F( /*#__PURE__*/function () {
      var _ref5 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
  ...
  setNetworkEnabled(t) {
    ...
    this.js.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this8.started && (yield _this8.ii());
    })));
  }
  /**
  ...
  wi() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this9.isPrimary && !_this9.mi(_this9.Zs, 18e5)) {
        ...
        if (_this9.si) for (const e of t) _this9.si.removeItem(_this9.yi(e.clientId));
      }
    })();
  }
  /**
  ...
  ui() {
    ...
    , 4e3, () => this.ii().then(() => this.wi()).then(() => this.ui()));
  }
  ...
  shutdown() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this10.vs = !1, _this10.Ii(), _this10.Xs && (_this10.Xs.cancel(), _this10.Xs = null), _this10.Ti(), _this10.Ei(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
      // has obtained the primary lease.
      yield _this10.ni.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], t => {
        const e = new Oi(t, $t.ot);
        return _this10.li(e).next(() => _this10._i(e));
      }), _this10.ni.close(), // Remove the entry marking the client as zombied from LocalStorage since
  ...
  runTransaction(t, e, n) {
    ...
    return this.ni.runTransaction(t, s, i, s => (o = new Oi(s, this.Ps ? this.Ps.next() : $t.ot), "readwrite-primary" === e ? this.ai(o).next(t => !!t || this.hi(o)).next(e => {
      if (!e) throw F(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = !1, this.js.enqueueRetryable(() => this.ti(!1)), new Q(G.FAILED_PRECONDITION, At);
      return n(o);
  ...
  oi() {
    ...
    "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.Js = () => {
      ...
      this.Ii(), (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.isSafari)() && navigator.appVersion.match(/Version\/1[45]/) && // On Safari 14 and 15, we do not run any cleanup actions as it might
      // trigger a bug that prevents Safari from re-opening IndexedDB during
      // the next page load.
      // See https://bugs.webkit.org/show_bug.cgi?id=226547
      this.js.enterRestrictedMode(
      /* purgeExistingTasks= */
      !0), this.js.enqueueAndForget(() => this.shutdown());
...
class Eo {
  ...
  xi(t, e, n, s) {
    return on(e) || s.isEqual(ct.min()) ? this.Ni(t, e) : this.Di.getDocuments(t, n).next(i => {
      const r = this.ki(e, i);
      return this.Oi(e, r, n, s) ? this.Ni(t, e) : (k() <= _firebase_logger__WEBPACK_IMPORTED_MODULE_3__.LogLevel.DEBUG && M("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), wn(e)), this.Mi(t, r, e, pt(s, -1)));
  ...
  Ni(t, e) {
    return k() <= _firebase_logger__WEBPACK_IMPORTED_MODULE_3__.LogLevel.DEBUG && M("QueryEngine", "Using full collection scan to execute query:", wn(e)), this.Di.getDocumentsMatchingQuery(t, e, Tt.min());
  }
  /**
  ...
  Mi(t, e, n, s) {
    ...
    return this.Di.getDocumentsMatchingQuery(t, n, s).next(t => ( // Merge with existing results
    e.forEach(e => {
      t = t.insert(e.key, e);
    }), t));
  }
...
function _bo() {
  _bo = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t);
...
function Co(t, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", t => {
    let s;
    return n.Vs.getTargetData(t, e).next(i => i ? ( // This target has been listened to previously, so reuse the
    // previous targetID.
    // TODO(mcg): freshen last accessed date?
    s = i, Pt.resolve(s)) : n.Vs.allocateTargetId(t).next(i => (s = new Li(e, i, 0
    /* Listen */
    , t.currentSequenceNumber), n.Vs.addTargetData(t, s).next(() => s))));
  }).then(t => {
...
function _xo() {
  _xo = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = K(t),
          i = s.$i.get(e),
    ...
    try {
      ...
      if (!Ct(t)) throw t; // All `releaseTarget` does is record the final metadata state for the
...
function Fo(_x9, _x10, _x11, _x12) {
...
function _Fo() {
  _Fo = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
    const i = K(t);
    let r = ws(),
        o = os();
...
function _$o() {
  _$o = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n = ws()) {
    // Allocate a target for the named query such that it can be resumed
    // from associated read time if users use it to listen.
    // NOTE: this also means if no corresponding target exists, the new target
    // will remain active and will not get collected, unless users happen to
    // unlisten the query somehow.
    const s = yield Co(t, ln(Ji(e.bundledQuery))),
          i = K(t);
    return i.persistence.runTransaction("Save named query", "readwrite", t => {
      const r = Ns(e.readTime); // Simply save the query itself if it is older than what the SDK already
      // has.
...
class Go {
  ...
  static Ji(t, e) {
    ...
    for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = ce(n.activeTargetIds[t]), i = i.add(n.activeTargetIds[t]);
...
class Wo {
  constructor(t, e, n, s, i) {
    ...
    * limitations under the License.
    */
    (this.persistenceKey), this.sr = this.sr.insert(this.tr, new jo()), this.cr = new RegExp(`^firestore_clients_${r}_([^_]*)$`), this.ar = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this.hr = new RegExp(`^firestore_targets_${r}_(\\d+)$`), this.lr =
  ...
  start() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      // SharedClientState.
      const t = yield _this11.syncEngine.Ri();

      for (const e of t) {
        if (e === _this11.tr) continue;

        const t = _this11.getItem(Bo(_this11.persistenceKey, e));

        if (t) {
          const n = Go.Ji(e, t);
          n && (_this11.sr = _this11.sr.insert(n.clientId, n));
        }
      }

      _this11._r(); // Check if there is an existing online state and call the callback handler
      // if applicable.


      const e = _this11.storage.getItem(_this11.lr);

      if (e) {
        const t = _this11.wr(e);

        t && _this11.mr(t);
      }

      for (const t of _this11.ir) _this11.nr(t);

      _this11.ir = [], // Register a window unload hook to remove the client metadata entry from
  ...
  nr(t) {
    ...
    if (e.storageArea === this.storage) {
      ...
      this.js.enqueueRetryable( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        if (_this12.started) {
          if (null !== e.key) if (_this12.cr.test(e.key)) {
            if (null == e.newValue) {
              const t = _this12.Rr(e.key);

              return _this12.br(t, null);
            }

            {
              const t = _this12.Pr(e.key, e.newValue);

              if (t) return _this12.br(t.clientId, t);
            }
          } else if (_this12.ar.test(e.key)) {
            if (null !== e.newValue) {
              const t = _this12.vr(e.key, e.newValue);

              if (t) return _this12.Vr(t);
            }
          } else if (_this12.hr.test(e.key)) {
            if (null !== e.newValue) {
              const t = _this12.Sr(e.key, e.newValue);

              if (t) return _this12.Dr(t);
            }
          } else if (e.key === _this12.lr) {
            if (null !== e.newValue) {
              const t = _this12.wr(e.newValue);

              if (t) return _this12.mr(t);
            }
          } else if (e.key === _this12.ur) {
            const t = function (t) {
              let e = $t.ot;
              if (null != t) try {
            ...
            */
            ...
            t !== $t.ot && _this12.sequenceNumberHandler(t);
          } else if (e.key === _this12.dr) {
            const t = _this12.Cr(e.newValue);

            yield Promise.all(t.map(t => _this12.syncEngine.Nr(t)));
          }
        } else _this12.ir.push(e);
      }));
    }
  }
  ...
  yr(t, e, n) {
    const s = new qo(this.currentUser, t, e, n),
  ...
  Tr(t, e, n) {
    const s = Uo(this.persistenceKey, t),
          i = new Ko(t, e, n);
    this.setItem(s, i.Yi());
  }
  ...
  Vr(t) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (t.user.uid === _this13.currentUser.uid) return _this13.syncEngine.kr(t.batchId, t.state, t.error);
  ...
  br(t, e) {
    const n = e ? this.sr.insert(t, e) : this.sr.remove(t),
          s = this.gr(this.sr),
          i = this.gr(n),
          r = [],
          o = [];
...
class {
  ...
  ro(t, e, n, s, i) {
    ...
    const o = {};
    return this.uo(o, s, i), this.co(t, r, o, n).then(t => (M("RestConnection", "Received: ", t), t), e => {
  ...
  ho(t, e, n) {
    const s = [this.so, "/", "google.firestore.v1.Firestore", "/", t, "/channel"],
    ...
    this.useFetchStreams && (o.xmlHttpFactory = new _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.FetchXmlHttpFactory({})), this.uo(o.initMessageHeaders, e, n), // Sending the custom headers we just added to request.initMessageHeaders
    ...
    return y(c, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.WebChannel.EventType.OPEN, () => {
      h || M("Connection", "WebChannel transport opened.");
    }), y(c, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.WebChannel.EventType.CLOSE, () => {
      h || (h = !0, M("Connection", "WebChannel transport closed"), l.eo());
    }), y(c, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.WebChannel.EventType.ERROR, t => {
      h || (h = !0, $("Connection", "WebChannel transport errored:", t), l.eo(new Q(G.UNAVAILABLE, "The operation could not be completed")));
    }), y(c, _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_5__.WebChannel.EventType.MESSAGE, t => {
      var e;
...
class su {
  ...
  Io(t) {
    ...
    const e = Math.floor(this.wo + this.To()),
...
class iu {
  ...
  stop() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this14.Do() && (yield _this14.close(0
      /* Initial */
      ));
    })();
  }
  ...
  Oo() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this15.Co()) // When timing out an idle stream there's no reason to force the stream into backoff when
  ...
  close(t, e) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this16.Fo(), _this16.$o(), _this16.So.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
      // underlying stream), guaranteeing they won't execute.
      _this16.Po++, 4
      /* Error */
      !== t ? // If this is an intentional close ensure we don't delay our next connection attempt.
      _this16.So.reset() : e && e.code === G.RESOURCE_EXHAUSTED ? ( // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
      F(e.toString()), F("Using maximum backoff delay to prevent overloading the backend."), _this16.So.po()) : e && e.code === G.UNAUTHENTICATED && 3
      /* Healthy */
      ...
      null !== _this16.stream && (_this16.Bo(), _this16.stream.close(), _this16.stream = null), // This state must be assigned before calling onClose() to allow the callback to
      // inhibit backoff or otherwise manipulate the state in its non-started state.
      _this16.state = t, // Notify the listener that the stream closed.
      yield _this16.listener.Jr(e);
    })();
  }
  /**
  ...
  auth() {
    ...
    Promise.all([this.authCredentialsProvider.getToken(), this.appCheckCredentialsProvider.getToken()]).then(([t, n]) => {
      ...
      this.Po === e && // Normally we'd have to schedule the callback on the AsyncQueue.
  ...
  Uo(t, e) {
    ...
    this.stream = this.Ko(t, e), this.stream.zr(() => {
      n(() => (this.state = 2
      /* Open */
      , this.Vo = this.js.enqueueAfterDelay(this.Ro, 1e4, () => (this.Co() && (this.state = 3
      /* Healthy */
  ...
  xo() {
    ...
    this.state = 5
    /* Backoff */
    , this.So.Io( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this17.state = 0
      /* Initial */
      , _this17.start();
    }));
...
class ou extends iu {
  ...
  onMessage(t) {
    ...
    U(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Wo) {
      ...
      this.So.reset();
      const e = zs(t.writeResults, t.commitTime),
            n = Ns(t.commitTime);
...
class cu {
  ...
  iu() {
    ...
    /* OnlineStateTimeout */
    , 1e4, () => (this.nu = null, this.ou("Backend didn't respond within 10 seconds."), this.ru("Offline"
    /* Offline */
    ), Promise.resolve())));
  }
  /**
  ...
  uu(t) {
    ...
    /* Unknown */
    ) : (this.eu++, this.eu >= 1 && (this.cu(), this.ou(`Connection failed 1 times. Most recent error: ${t.toString()}`), this.ru("Offline"
    /* Offline */
    )));
  }
  /**
...
class au {
  ...
  e, n, s, i) {
    ...
    this.fu = [], this.du = i, this.du.Br(t => {
      n.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        // Porting Note: Unlike iOS, `restartNetwork()` is called even when the
        // network becomes unreachable as we don't have any other way to tear
        // down our streams.
        yu(_this18) && (M("RemoteStore", "Restarting streams for network reachability change."), yield function () {
          var _ref10 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
            const e = K(t);
            e.lu.add(4
            /* ConnectivityChange */
            ), yield lu(e), e._u.set("Unknown"
            /* Unknown */
            ), e.lu.delete(4
            /* ConnectivityChange */
            ), yield hu(e);
...
function _hu() {
  _hu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    if (yu(t)) for (const e of t.fu) yield e(
    /* enabled= */
    !0);
  });
  return _hu.apply(this, arguments);
...
function _lu() {
  _lu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    for (const e of t.fu) yield e(
    /* enabled= */
    !1);
  });
  return _lu.apply(this, arguments);
...
function _Iu() {
  _Iu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    t.hu.forEach((e, n) => {
      _u(t, e);
    });
  });
...
function Tu(_x19, _x20) {
  return _Tu.apply(this, arguments);
}

function _Tu() {
  _Tu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
...
function _Eu() {
  _Eu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    ...
    === e.state && e.cause) // There was an error on a target, don't wait for a consistent snapshot
      ...
      try {
        yield (
          ...
          function () {
            var _ref42 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
              const n = e.cause;

              for (const s of e.targetIds) // A watched target might have been removed already.
              t.hu.has(s) && (yield t.remoteSyncer.rejectListen(s, n), t.hu.delete(s), t.wu.removeTarget(s));
            });
        ...
        M("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), n), yield Au(t, n);
      } else if (e instanceof Is ? t.wu.Ut(e) : e instanceof Ts ? t.wu.zt(e) : t.wu.Gt(e), !n.isEqual(ct.min())) try {
      const e = yield vo(t.localStore);
      ...
      yield (
        ...
        */
        function (t, e) {
          const n = t.wu.Yt(e); // Update in-memory resume tokens. LocalStore will update the
          // persistent view of these when applying the completed RemoteEvent.

          return n.targetChanges.forEach((n, s) => {
            if (n.resumeToken.approximateByteSize() > 0) {
              const i = t.hu.get(s); // A watched target might have been removed already.
      ...
      M("RemoteStore", "Failed to raise snapshot:", e), yield Au(t, e);
    }
  });
  return _Eu.apply(this, arguments);
}

function Au(_x24, _x25, _x26) {
...
function _Au() {
  _Au = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    if (!Ct(e)) throw e;
    t.lu.add(1
    /* IndexedDbFailed */
    ), // Disable network and raise offline snapshots
    yield lu(t), t._u.set("Offline"
    /* Offline */
    ), n || ( // Use a simple read operation to determine if IndexedDB recovered.
    // Ideally, we would expose a health check directly on SimpleDb, but
    // RemoteStore only has access to persistence through LocalStore.
    n = () => vo(t.localStore)), // Probe IndexedDB periodically and re-enable network
    t.asyncQueue.enqueueRetryable( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      M("RemoteStore", "Retrying IndexedDB access"), yield n(), t.lu.delete(1
      /* IndexedDbFailed */
      ), yield hu(t);
    }));
  });
...
function _bu() {
  _bu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    const e = K(t),
          n = Fu(e);
    let s = e.au.length > 0 ? e.au[e.au.length - 1].batchId : -1;

    for (; Pu(e);) try {
      const t = yield Do(e.localStore, s);
...
function _Du() {
  _Du = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    Fu(t).Xo();
  });
  return _Du.apply(this, arguments);
}
...
function _Cu() {
  _Cu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    const e = Fu(t); // Send the write pipeline now that the stream is established.
...
function xu(_x30, _x31, _x32) {
  return _xu.apply(this, arguments);
}

function _xu() {
  _xu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = t.au.shift(),
          i = $i.from(s, e, n);
    yield Ru(t, () => t.remoteSyncer.applySuccessfulWrite(i)), // It's possible that with the completion of this mutation another
    // slot has freed up.
    yield bu(t);
  });
  return _xu.apply(this, arguments);
...
function Nu(_x33, _x34) {
  return _Nu.apply(this, arguments);
}

function _Nu() {
  _Nu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    // If the write stream closed after the write handshake completes, a write
    // operation failed and we fail the pending operation.
    e && Fu(t).zo && ( // This error affects the actual write.
    yield function () {
      var _ref44 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
        // Only handle permanent errors here. If it's transient, just let the retry
        // logic kick in.
        if (n = e.code, ns(n) && n !== G.ABORTED) {
          // This was a permanent error, the request itself was the problem
          // so it's not going to succeed if we resend it.
          const n = t.au.shift(); // In this case it's also unlikely that the server itself is melting
          // down -- this was just a bad request so inhibit backoff on the next
          // restart.

          Fu(t).No(), yield Ru(t, () => t.remoteSyncer.rejectFailedWrite(n.batchId, e)), // It's possible that with the completion of this mutation
...
function _ku() {
  _ku = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t);
    n.asyncQueue.verifyOperationInProgress(), M("RemoteStore", "RemoteStore received new credentials");
    const s = yu(n); // Tear down and re-create our network streams. This will ensure we get a
    // fresh auth token for the new user and re-fill the write pipeline with
    // new mutations from the LocalStore (since mutations are per-user).

    n.lu.add(3
    /* CredentialChange */
    ), yield lu(n), s && // Don't set the network status to Unknown if we are offline.
    n._u.set("Unknown"
    /* Unknown */
    ), yield n.remoteSyncer.handleCredentialChange(e), n.lu.delete(3
    /* CredentialChange */
    ), yield hu(n);
  });
  return _ku.apply(this, arguments);
...
function _Ou() {
  _Ou = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t);
    e ? (n.lu.delete(2
    /* IsSecondary */
    ), yield hu(n)) : e || (n.lu.add(2
    /* IsSecondary */
    ), yield lu(n), n._u.set("Unknown"
    /* Unknown */
    ));
  });
  return _Ou.apply(this, arguments);
...
function Mu(t) {
  ...
  */
  (t.datastore, t.asyncQueue, {
    ...
    var _ref11 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
      e ? (t.mu.No(), gu(t) ? mu(t) : t._u.set("Unknown"
      /* Unknown */
      )) : (yield t.mu.stop(), pu(t));
    });
...
function Fu(t) {
  ...
  t.gu = function (t, e, n) {
    ...
    var _ref12 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
      e ? (t.gu.No(), // This will start the write stream if necessary.
      yield bu(t)) : (yield t.gu.stop(), t.au.length > 0 && (M("RemoteStore", `Stopping write stream with ${t.au.length} pending writes`), t.au = []));
    });
...
class Lu {
  ...
  constructor(t) {
    ...
    this.comparator = t ? (e, n) => t(e, n) || dt.comparator(e.key, n.key) : (t, e) => dt.comparator(t.key, e.key), this.keyedMap = cs(), this.sortedSet = new qt(this.comparator);
  }
  /**
...
class Gu {
  constructor() {
    this.queries = new is(t => _n(t), dn), this.onlineState = "Unknown"
    /* Unknown */
    , this.Tu = new Set();
  }
...
function Qu(_x41, _x42) {
  return _Qu.apply(this, arguments);
}

function _Qu() {
  _Qu = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t),
          s = e.query;
    let i = !1,
        r = n.queries.get(s);
    if (r || (i = !0, r = new Ku()), i) try {
      r.Iu = yield n.onListen(s);
    } catch (t) {
...
function ju(_x43, _x44) {
  return _ju.apply(this, arguments);
}

function _ju() {
  _ju = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t),
          s = e.query;
    let i = !1;
...
class Zu {
  ...
  complete() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const t = yield Fo(_this19.localStore, new Xu(_this19.wt), _this19.documents, _this19.xu.id),
            e = _this19.ku(_this19.documents);

      for (const t of _this19.queries) yield $o(_this19.localStore, t, e.get(t.name));

      return _this19.progress.taskState = "Success", {
        progress: _this19.progress,
        Ou: _this19.collectionGroups,
        Mu: t
      };
    })();
  }
...
class sc {
  ...
  ju(t) {
    t && (t.addedDocuments.forEach(t => this.Fu = this.Fu.add(t)), t.modifiedDocuments.forEach(t => {}), t.removedDocuments.forEach(t => this.Fu = this.Fu.delete(t)), this.current = t.current);
  }
...
class oc {
  ...
  s, i, r) {
    this.localStore = t, this.remoteStore = e, this.eventManager = n, this.sharedClientState = s, this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.Zu = {}, this.tc = new is(t => _n(t), dn), this.ec = new Map(),
    /**
...
function _uc() {
  _uc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = Mc(t);
    let s, i;
    const r = n.tc.get(e);
...
function cc(_x47, _x48, _x49, _x50) {
...
function _cc() {
  _cc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
    // PORTING NOTE: On Web only, we inject the code that registers new Limbo
    // targets based on view changes. This allows us to only depend on Limbo
    // changes when user code includes queries.
    t.hc = (e, n, s) => function () {
      var _ref45 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
        let i = e.view.Ku(n);
        i.Oi && ( // The query has a limit and some docs were removed, so we need
        // to re-run the query against the local store to make sure we
        // didn't lose any good docs that had been past the limit.
        i = yield No(t.localStore, e.query,
        /* usePreviousResults= */
        !1).then(({
          documents: t
        }) => e.view.Ku(t, i)));
    ...
    const i = yield No(t.localStore, e,
    /* usePreviousResults= */
    !0),
          r = new sc(e, i.ji),
          o = r.Ku(i.documents),
...
function _ac() {
  _ac = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t),
          s = n.tc.get(e),
          i = n.ec.get(s.targetId);
    if (i.length > 1) return n.ec.set(s.targetId, i.filter(t => !dn(t, e))), void n.tc.delete(e); // No other queries are mapped to the target, clean up the query and the target.

    if (n.isPrimaryClient) {
      // We need to remove the local query target first to allow us to verify
      // whether any other client is still interested in this target.
      n.sharedClientState.removeLocalQueryTarget(s.targetId);
      n.sharedClientState.isActiveQueryTarget(s.targetId) || (yield xo(n.localStore, s.targetId,
      /*keepPersistedTargetData=*/
      !1).then(() => {
        n.sharedClientState.clearQueryState(s.targetId), du(n.remoteStore, s.targetId), pc(n, s.targetId);
      }).catch(bt));
    } else pc(n, s.targetId), yield xo(n.localStore, s.targetId,
    /*keepPersistedTargetData=*/
    !0);
  });
  return _ac.apply(this, arguments);
...
function _hc() {
  _hc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = Fc(t);
    ...
    try {
      ...
      * it.
      */
      (s, t.batchId, n), yield Rc(s, t.changes), yield bu(s.remoteStore);
    } catch (t) {
...
function _lc() {
  _lc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t);

    try {
      const t = yield Vo(n.localStore, e); // Update `receivedDocument` as appropriate for any limbo targets.
...
function dc(_x58, _x59, _x60) {
  return _dc.apply(this, arguments);
}

function _dc() {
  _dc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    ...
    if (r) {
      ...
      let t = new qt(dt.comparator); // TODO(b/217189216): This limbo document should ideally have a read time,
      ...
      /* targetMismatches= */
      new Qt(it), t, n);
      yield lc(s, i), // Since this query failed, we won't want to manually unlisten to it.
      // We only remove it from bookkeeping after we successfully applied the
      // RemoteEvent. If `applyRemoteEvent()` throws, we want to re-listen to
      // this query when the RemoteStore restarts the Watch stream, which should
      // re-trigger the target failure.
      s.sc = s.sc.remove(r), s.ic.delete(e), Ac(s);
    } else yield xo(s.localStore, e,
    /* keepPersistedTargetData */
    !1).then(() => pc(s, e, n)).catch(bt);
  });
  return _dc.apply(this, arguments);
}

function _c(_x61, _x62) {
  return _c2.apply(this, arguments);
}

function _c2() {
  _c2 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t),
          s = e.batch.batchId;

    try {
      const t = yield Po(n.localStore, e); // The local store may or may not be able to apply the write result and
      ...
      yc(n, s,
      /*error=*/
      null), gc(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), yield Rc(n, t);
    } catch (t) {
      yield bt(t);
    }
  });
...
function _wc() {
  _wc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = K(t);
    ...
    try {
      ...
      */
      ...
      yc(s, e, n), gc(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), yield Rc(s, t);
    } catch (n) {
      yield bt(n);
    }
  });
...
function _mc() {
  _mc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t);
...
function yc(t, e, n) {
  const s = K(t);
  let i = s.oc[s.currentUser.toKey()]; // NOTE: Mutations restored from persistence won't have callbacks, so it's
...
function Ac(t) {
  for (; t.nc.size > 0 && t.sc.size < t.maxConcurrentLimboResolutions;) {
    ...
    t.nc.delete(e);
    const n = new dt(ht.fromString(e)),
          s = t.cc.next();
...
function Rc(_x68, _x69, _x70) {
  return _Rc.apply(this, arguments);
}

function _Rc() {
  _Rc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = K(t),
          i = [],
          r = [],
          o = [];
    ...
    }), yield Promise.all(o), s.Zu.Go(i), yield function () {
      var _ref46 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
        const n = K(t);

        try {
          yield n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", t => Pt.forEach(e, e => Pt.forEach(e.Pi, s => n.persistence.referenceDelegate.addReference(t, e.targetId, s)).next(() => Pt.forEach(e.vi, s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))));
        } catch (t) {
          if (!Ct(t)) throw t; // If `notifyLocalViewChanges` fails, we did not advance the sequence
...
function bc(_x71, _x72) {
  return _bc.apply(this, arguments);
}

function _bc() {
  _bc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t);
    ...
    if (!n.currentUser.isEqual(e)) {
      ...
      n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), yield Rc(n, t.Ki);
    }
  });
  return _bc.apply(this, arguments);
}
...
function _vc() {
  _vc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t),
          s = yield No(n.localStore, e.query,
    /* usePreviousResults= */
    !0),
          i = e.view.Ju(s);
...
function Sc(_x77, _x78, _x79, _x80) {
...
function _Sc() {
  _Sc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
    const i = K(t),
    ...
    yield bu(i.remoteStore) : "acknowledged" === n || "rejected" === n ? ( // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    yc(i, e, s || null), gc(i, e), function (t, e) {
      K(K(t).mutationQueue).In(e);
    } // PORTING NOTE: Multi-Tab only.
    (i.localStore, e)) : L(), yield Rc(i, r)) : // A throttled tab may not have seen the mutation before it was completed
...
function Dc(_x81, _x82) {
  return _Dc.apply(this, arguments);
}

function _Dc() {
  _Dc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    const n = K(t);
    ...
    if (Mc(n), Fc(n), !0 === e && !0 !== n.ac) {
      ...
      const t = n.sharedClientState.getAllActiveQueryTargets(),
            e = yield Cc(n, t.toArray());
      n.ac = !0, yield Ou(n.remoteStore, !0);
      ...
      n.ec.forEach((s, i) => {
        n.sharedClientState.isLocalQueryTarget(i) ? t.push(i) : e = e.then(() => (pc(n, i), xo(n.localStore, i,
        /*keepPersistedTargetData=*/
        !0))), du(n.remoteStore, i);
      }), yield e, yield Cc(n, t), // PORTING NOTE: Multi-Tab only.
      function (t) {
        const e = K(t);
        e.ic.forEach((t, n) => {
          du(e.remoteStore, n);
      ...
      */
      // PORTING NOTE: Multi-Tab only.
      (n), n.ac = !1, yield Ou(n.remoteStore, !1);
    }
  });
  return _Dc.apply(this, arguments);
}

function Cc(_x83, _x84, _x85) {
  return _Cc.apply(this, arguments);
}
/**
...
function _Cc() {
  _Cc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = K(t),
          i = [],
          r = [];
    ...
    for (const t of e) {
      ...
      if (n && 0 !== n.length) {
        ...
        e = yield Co(s.localStore, ln(n[0]));
        ...
        const n = yield ko(s.localStore, t);
        e = yield Co(s.localStore, n), yield cc(s, xc(n), t,
        /*current=*/
        !1);
      }
...
function kc(_x86, _x87, _x88, _x89) {
...
function _kc() {
  _kc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n, s) {
    const i = K(t);
    ...
    if (r && r.length > 0) switch (n) {
      ...
      case "not-current":
        {
          const t = yield Oo(i.localStore, gn(r[0])),
                s = ys.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
          yield Rc(i, t, s);
          break;
        }

      case "rejected":
        yield xo(i.localStore, e,
        /* keepPersistedTargetData */
        !0), pc(i, e, s);
        break;
...
function Oc(_x90, _x91, _x92) {
  return _Oc.apply(this, arguments);
}

function _Oc() {
  _Oc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
    const s = Mc(t);
    ...
    if (s.ac) {
      for (const t of e) {
        ...
        const e = yield ko(s.localStore, t),
              n = yield Co(s.localStore, e);
        yield cc(s, xc(e), n.targetId,
        /*current=*/
        !1), fu(s.remoteStore, n);
      }

      for (const t of n) // Check that the target is still active since the target might have been
      // removed if it has been rejected by the backend.
      s.ec.has(t) && ( // Release queries that are still active.
      yield xo(s.localStore, t,
      /* keepPersistedTargetData */
      !1).then(() => {
...
function $c(t, e, n) {
  ...
  (function () {
    var _ref13 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
      try {
        ...
        */
        ...
        for (; r;) {
          const t = yield i.Nu(r);
          t && n._updateProgress(t), r = yield e.fc();
        }

        const o = yield i.complete();
        return yield Rc(t, o.Mu,
        /* remoteEvent */
...
class Bc {
  ...
  initialize(t) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this20.wt = nu(t.databaseInfo.databaseId), _this20.sharedClientState = _this20.dc(t), _this20.persistence = _this20._c(t), yield _this20.persistence.start(), _this20.localStore = _this20.wc(t), _this20.gcScheduler = _this20.mc(t, _this20.localStore), _this20.indexBackfillerScheduler = _this20.gc(t, _this20.localStore);
    })();
  }
...
class Lc extends Bc {
  ...
  initialize(t) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _superprop_getInitialize().call(_this22, t), yield _this22.yc.initialize(_this22, t), // Enqueue writes from a previous session
      yield Fc(_this22.yc.syncEngine), yield bu(_this22.yc.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
      // set it after localStore / remoteStore are started.
      yield _this22.persistence.ci(() => (_this22.gcScheduler && !_this22.gcScheduler.started && _this22.gcScheduler.start(), _this22.indexBackfillerScheduler && !_this22.indexBackfillerScheduler.started && _this22.indexBackfillerScheduler.start(), Promise.resolve()));
    })();
  }
  ...
  _c(t) {
    const e = Io(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey),
...
class Uc extends Lc {
  constructor(t, e) {
    super(t, e,
    /* forceOwnership= */
    !1), this.yc = t, this.cacheSizeBytes = e, this.synchronizeTabs = !0;
  }
  ...
  initialize(t) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const e = _this23.yc.syncEngine;
      _this23.sharedClientState instanceof Wo && (_this23.sharedClientState.syncEngine = {
        kr: Sc.bind(null, e),
        Or: kc.bind(null, e),
        Mr: Oc.bind(null, e),
        Ri: Nc.bind(null, e),
      ...
      // set it after localStore / remoteStore are started.
      yield _this23.persistence.ci( /*#__PURE__*/function () {
        var _ref14 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
          yield Dc(_this23.yc.syncEngine, t), _this23.gcScheduler && (t && !_this23.gcScheduler.started ? _this23.gcScheduler.start() : t || _this23.gcScheduler.stop()), _this23.indexBackfillerScheduler && (t && !_this23.indexBackfillerScheduler.started ? _this23.indexBackfillerScheduler.start() : t || _this23.indexBackfillerScheduler.stop());
        });
...
class qc {
  initialize(t, e) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      /* startAsPrimary=*/
      !t.synchronizeTabs), _this24.sharedClientState.onlineStateHandler = t => fc(_this24.syncEngine, t, 1
      /* SharedClientState */
      ), _this24.remoteStore.remoteSyncer.handleCredentialChange = bc.bind(null, _this24.syncEngine), yield Ou(_this24.remoteStore, _this24.syncEngine.isPrimaryClient));
    })();
  }
  ...
  createDatastore(t) {
    const e = nu(t.databaseInfo.databaseId),
  ...
  createRemoteStore(t) {
    return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => fc(this.syncEngine, t, 0
    /* RemoteStore */
  ...
  terminate() {
    return function () {
      var _ref15 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
        const e = K(t);
        M("RemoteStore", "RemoteStore shutting down."), e.lu.add(5
        /* Shutdown */
        ), yield lu(e), e.du.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
class Qc {
  ...
  fc() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      return yield _this26.getMetadata(), _this26.Rc();
    })();
  }
  /**
  ...
  Rc() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const t = yield _this27.bc();
      if (null === t) return null;

      const e = _this27.Ac.decode(t),
            n = Number(e);

      isNaN(n) && _this27.Pc(`length string (${e}) is not valid number`);
      const s = yield _this27.vc(n);
  ...
  bc() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const t = _this28.Vc(); // Broke out of the loop because underlying stream is closed, but still
      // cannot find an open bracket.


      t < 0 && _this28.Pc("Reached the end of bundle when a length string is expected.");
  ...
  vc(t) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      for (; _this29.buffer.length < t;) {
        (yield _this29.Sc()) && _this29.Pc("Reached the end of bundle when more is expected.");
      }

      const e = _this29.Ac.decode(_this29.buffer.slice(0, t)); // Update the internal buffer to drop the read json string.
...
class jc {
  ...
  lookup(t) {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this31.ensureCommitNotCalled(), _this31.mutations.length > 0) throw new Q(G.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
      const e = yield function () {
        var _ref16 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
          const n = K(t),
                s = Ls(n.wt) + "/documents",
                i = {
            documents: e.map(t => Ms(n.wt, t))
          },
                r = yield n.ao("BatchGetDocuments", s, i, e.length),
                o = new Map();
          r.forEach(t => {
            const e = Gs(n.wt, t);
  ...
  commit() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      t.forEach((t, e) => {
        ...
        _this32.mutations.push(new Xn(n, _this32.precondition(n)));
      }), yield function () {
        var _ref17 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
          const n = K(t),
                s = Ls(n.wt) + "/documents",
                i = {
            writes: e.map(t => js(n.wt, t))
          };
          yield n.ro("Commit", s, i);
        });
...
class Wc {
  ...
  Cc() {
    ...
    this.So.Io( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const t = new jc(_this33.datastore),
            e = _this33.xc(t);
...
class zc {
  ...
  n, s) {
    ...
    this.authCredentials = t, this.appCheckCredentials = e, this.asyncQueue = n, this.databaseInfo = s, this.user = C.UNAUTHENTICATED, this.clientId = st.I(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this.authCredentials.start(n, /*#__PURE__*/function () {
      var _ref19 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
        M("FirestoreClient", "Received user=", t.uid), yield _this34.authCredentialListener(t), _this34.user = t;
      });
  ...
  terminate() {
    ...
    const t = new j();
    return this.asyncQueue.enqueueAndForgetEvenWhileRestricted( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
...
function Hc(_x103, _x104) {
  return _Hc.apply(this, arguments);
}

function _Hc() {
  _Hc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    ...
    t.setCredentialChangeListener( /*#__PURE__*/function () {
      var _ref47 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
        s.isEqual(t) || (yield bo(e.localStore, t), s = t);
      });
...
function _Jc() {
  _Jc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e) {
    ...
    t.setCredentialChangeListener(t => ku(e.remoteStore, t)), t.setAppCheckTokenChangeListener((t, n) => ku(e.remoteStore, n)), t.onlineComponents = e;
  });
  return _Jc.apply(this, arguments);
}
...
function _Yc() {
  _Yc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    return t.offlineComponents || (M("FirestoreClient", "Using default OfflineComponentProvider"), yield Hc(t, new Bc())), t.offlineComponents;
  });
  return _Yc.apply(this, arguments);
}
...
function _Xc() {
  _Xc = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    return t.onlineComponents || (M("FirestoreClient", "Using default OnlineComponentProvider"), yield Jc(t, new qc())), t.onlineComponents;
  });
  return _Xc.apply(this, arguments);
}
...
function _sa() {
  _sa = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
    const e = yield Xc(t),
          n = e.eventManager;
...
function ia(t) {
  return t.asyncQueue.enqueue( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    const e = yield Zc(t),
          n = yield ea(t);
...
function ra(t) {
  return t.asyncQueue.enqueue( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    return e.setNetworkEnabled(!1), function () {
      var _ref23 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
        const e = K(t);
        e.lu.add(0
        /* UserDisabled */
        ), yield lu(e), // Set the OnlineState to Offline so get()s return from cache, etc.
        e._u.set("Offline"
        /* Offline */
        );
      });
...
function oa(t, e) {
  const n = new j();
  return t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    return function () {
      var _ref25 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
        try {
...
function ca(t, e) {
  ...
  return t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    return function () {
      var _ref28 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t, e, n) {
        try {
          const s = yield No(t, e,
          /* usePreviousResults= */
          !0),
                i = new sc(e, s.ji),
                r = i.Ku(s.documents),
...
function ha(t, e) {
  ...
  return t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    n.Tc(), t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return function (t, e) {
        K(t).Tu.delete(e);
      }(yield sa(t), n);
    }));
...
function fa(t, e, n, s) {
  ...
  */
  ...
  t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    $c(yield na(t), i, s);
  }));
}
...
function Va(t, e, ...n) {
  if (t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t), wa("collection", "path", e), t instanceof Aa) {
...
function Ca(t, e) {
  return t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t), e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e), (t instanceof ba || t instanceof va) && (e instanceof ba || e instanceof va) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter;
}
/**
...
function xa(t, e) {
  return t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t), e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e), t instanceof Pa && e instanceof Pa && t.firestore === e.firestore && dn(t._query, e._query) && t.converter === e.converter;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class Na {
  ...
  jc() {
    ...
    return (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (0 !== _this37.Mc.length) {
        try {
          yield _this37.Mc[0](), _this37.Mc.shift(), _this37.So.reset();
        } catch (t) {
          if (!Ct(t)) throw t; // Failure will be handled by AsyncQueue

          M("AsyncQueue", "Operation failed with retryable error: " + t);
        }

        _this37.Mc.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  Jc(t) {
    ...
    return this.zc().then(() => {
      ...
      for (const e of this.$c) if (e.skipDelay(), "all"
      /* All */
      !== t && e.timerId === t) break;
...
function Ba(e = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_1__.getApp)()) {
...
function Ga(t, e, n) {
  ...
  return t.asyncQueue.enqueue( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    try {
      yield Hc(t, n), yield Jc(t, e), s.resolve();
    } catch (t) {
      const e = t;
      if (!
      /**
...
function Qa(t) {
  ...
  const e = new j();
  return t._queue.enqueueAndForgetEvenWhileRestricted( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    try {
      yield function () {
        var _ref37 = (0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
...
function lh(t, e, n, s, i, r = {}) {
  const o = t.aa(r.merge || r.mergeFields ? 2
  /* MergeSet */
  : 0
  /* Set */
  , e, n, i);
...
class fh extends nh {
  _toFieldTransform(t) {
    ...
    !== t.Zc) throw 1
    /* Update */
    === t.Zc ? t.oa(`${this._methodName}() can only appear at the top level of your update data`) : t.oa(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`); // No transform to add for a delete, but we need to add it to our
...
function yh(t, e, n, s) {
  ...
  const r = [],
        o = De.empty();
  Lt(s, (t, s) => {
    const u = vh(e, t, n); // For Compat types, we have to "extract" the underlying types before
...
function Th(t, e) {
  ...
  // from firestore-exp.
  t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t))) return Rh("Unsupported field value:", e, t), Eh(t, e);
...
function bh(t, e, n) {
  ...
  // FieldPath.
  e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e)) instanceof Za) return e._internalPath;
...
function el(t, e, n, s) {
  if (n[0] = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(n[0]), n[0] instanceof Dh) return function (t, e, n, s, i) {
...
class ol {
  ...
  convertDocumentKey(t, e) {
    ...
    U(ui(n));
    const s = new re(n.get(1), n.get(3)),
...
class al {
  ...
  update(t, e, n, ...s) {
    ...
    const i = hl(t, this._firestore); // For Compat types, we have to "extract" the underlying types before
    // performing validation.

    let r;
    return r = "string" == typeof (e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e)) || e instanceof Za ? ph(this._dataReader, "WriteBatch.update", i._key, e, n, s) : yh(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, $n.exists(!0))), this;
  }
  /**
...
function hl(t, e) {
  if ((t = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(t)).firestore !== e) throw new Q(G.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
  return t;
}
/**
 * @license
...
function pl(t, e, n, ...s) {
  t = Ia(t, ba);
  const i = Ia(t.firestore, Fa),
        r = hh(i);
  let o;
  o = "string" == typeof ( // For Compat types, we have to "extract" the underlying types before
  // performing validation.
  e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e)) || e instanceof Za ? ph(r, "updateDoc", t._key, e, n, s) : yh(r, "updateDoc", t._key, e);
...
function El(t, ...e) {
  ...
  return function (t, e, n, s) {
    const i = new Gc(s),
          r = new Ju(e, i, n);
    return t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return Qu(yield sa(t), r);
    })), () => {
      i.Tc(), t.asyncQueue.enqueueAndForget( /*#__PURE__*/(0,_usr_local_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        return ju(yield sa(t), r);
      }));
    };
  }(La(a), h, u, c);
}
...
class Pl extends class {
  ...
  update(t, e, n, ...s) {
    ...
    let r;
    return r = "string" == typeof (e = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_4__.getModularInstance)(e)) || e instanceof Za ? ph(this._dataReader, "Transaction.update", i._key, e, n, s) : yh(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  /**
   * Deletes the document referred to by the provided {@link DocumentReference}.
   *
...
function kl(t, e) {
  ...
  if (Array.isArray(n.indexes)) for (const t of n.indexes) {
    const e = Ol(t, "collectionGroup"),
          n = [];
    if (Array.isArray(t.fields)) for (const e of t.fields) {
      const t = vh("setIndexConfiguration", Ol(e, "fieldPath"));
      "CONTAINS" === e.arrayConfig ? n.push(new gt(t, 2
      /* CONTAINS */
      )) : "ASCENDING" === e.order ? n.push(new gt(t, 0
      /* ASCENDING */
      )) : "DESCENDING" === e.order && n.push(new gt(t, 1
      /* DESCENDING */
      ));
    }
...
!function (t, e = !0) {
  ...
  }, "PUBLIC")), (0,_firebase_app__WEBPACK_IMPORTED_MODULE_1__.registerVersion)(D, "3.4.11", t), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  (0,_firebase_app__WEBPACK_IMPORTED_MODULE_1__.registerVersion)(D, "3.4.11", "esm2017");
}();
...
/* harmony import */ var firebase_firestore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! firebase/firestore */ 22731);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs */ 57451);
...
/* harmony import */ var src_app_core_auto_api_common_api_api_firestore_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/auto_api/common_api/api/firestore.service */ 75929);
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./user.service */ 88386);
...
class FirestoreService {
    constructor(firestoreServiceApi, userService) {
        this.firestoreServiceApi = firestoreServiceApi;
        this.userService = userService;
        this.firestoreDbs = {};
        this.listSubscribers = {};
        this.app = (0,firebase_app__WEBPACK_IMPORTED_MODULE_0__.initializeApp)(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.firestoreConfig_app1, 'firestoreapp');
    }
    // Utils for exam_sessions
    examSessions_read(examHashId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDb(false).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var fireResponse = yield this._getDocument(response.data, 'exam_sessions/' + examHashId, this.getUserId());
                        var returnObj = { success: 1, data: fireResponse, message: 'successful' };
                        subscriber.next(returnObj);
                        subscriber.complete();
                    }
                    catch (ex) {
                        console.log(ex);
                        var returnObj = { success: 0, data: '', message: '' + ex };
                        subscriber.next(returnObj);
                        subscriber.complete();
                    }
                }
                else {
                    var returnObj = { success: 0, data: '', message: response.message };
                    subscriber.next(returnObj);
                    subscriber.complete();
                }
            }));
    ...
    examSessions_write(examHashId, dataObj) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDb(false).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var fireResponse = yield this._saveDocument(response.data, 'exam_sessions/' + examHashId, this.getUserId(), dataObj);
                        var returnObj = { success: 1, data: fireResponse, message: 'successful' };
                        subscriber.next(returnObj);
                        subscriber.complete();
                    }
    ...
    examSessions_writeUserMap(examHashId, dataObj) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForStudentExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1 && response.data) {
                    try {
                        var fireResponse = yield this._saveDocumentMerge(response.data, 'exam_sessions/' + examHashId, 'user_map', dataObj);
                        var returnObj = { success: 1, data: fireResponse, message: 'successful' };
                        subscriber.next(returnObj);
                        subscriber.complete();
                    }
    ...
    examSessions_delete(examHashId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDb(false).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        yield this._removeDocument(response.data, 'exam_sessions/' + examHashId, this.getUserId());
                        var returnObj = { success: 1, data: '', message: 'successful' };
                        subscriber.next(returnObj);
                        subscriber.complete();
                    }
                    catch (ex) {
    ...
    examSessions_subscribeUserMap(examHashId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForTeacherExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var unsubscriber = this.myOnSnapshot(response.data, 'exam_sessions/' + examHashId, 'user_map', (fireResponse) => {
                            var returnObj1 = { success: 1, data: fireResponse, message: 'successful' };
                            subscriber.next(returnObj1);
                            subscriber.complete();
                        });
                        this.addUnsubscribe('exam_sessions_' + examHashId, unsubscriber);
                    }
                    catch (ex) {
                        console.log(ex);
                        var returnObj2 = { success: 0, data: undefined, message: '' + ex };
                        subscriber.next(returnObj2);
                        subscriber.complete();
                    }
                }
                else {
                    var returnObj3 = { success: 0, data: undefined, message: response.message };
                    subscriber.next(returnObj3);
                    subscriber.complete();
                }
            }));
        });
    }
    examSessions_subscribe(examHashId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDb(false).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var unsubscriber = this.myOnSnapshot(response.data, 'exam_sessions/' + examHashId, this.getUserId(), (fireResponse) => {
                            var returnObj1 = { success: 1, data: fireResponse, message: 'successful' };
                            subscriber.next(returnObj1);
                            subscriber.complete();
                        });
    ...
    examSessions_unsubscribe(examHashId) {
        this.removeAllunsubscribe('exam_sessions_' + examHashId);
    }
    examSessions_subscribeWithQuery(examHashId, queryParams) {
        if (!queryParams || queryParams.length != 3) {
            return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
                var returnObj3 = { success: 0, data: undefined, message: 'EXCEPTION Query Param not valid' };
                subscriber.next(returnObj3);
                subscriber.complete();
                subscriber.next({ success: 0, message: 'EXCEPTION Query Param not valid' });
            });
        }
        else {
            return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
                this.getFirestoreDb(false).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                    if (response && response.success == 1) {
                        try {
                            var unsubscriber = this.myOnSnapshotCollectionWithQuery(response.data, 'exam_sessions/' + examHashId, queryParams, (fireResponse) => {
                                var returnObj1 = { success: 1, data: fireResponse, message: 'successful' };
                                subscriber.next(returnObj1);
                                subscriber.complete();
                            });
    ...
    // Utils for exam_live_teachers
    examLiveTeachers_student_subscribe(examHashId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForStudentExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var unsubscriber = this.myOnSnapshotCollection(response.data, 'exam_live_teachers/' + examHashId, (fireResponse) => {
                            subscriber.next({ success: 1, data: fireResponse });
                        });
                        this.addUnsubscribe('exam_live_teachers_' + examHashId, unsubscriber);
                    }
                    catch (ex) {
                        console.log(ex);
                        subscriber.next({ success: 0, message: 'EXCEPTION', ex: ex.toString() });
                    }
                }
                else {
    ...
    examLiveTeachers_student_unbsubscribe(examHashId) {
        this.removeAllunsubscribe('exam_live_teachers_' + examHashId);
    }
    examLiveTeachers_teacher_saveChange(examHashId, dataObj) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForTeacherExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var fireResponse = yield this._saveDocument(response.data, 'exam_live_teachers/' + examHashId, this.getUserId(), dataObj);
                        subscriber.next({ success: 1, data: fireResponse });
                    }
                    catch (ex) {
                        console.log(ex);
    ...
    // Utils for exam_lives
    examLives_teacher_getDocumentByUserIds(examHashId, userIds) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForTeacherExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var fireResponse = yield this._getDocuments(response.data, 'exam_lives/' + examHashId, userIds);
                        subscriber.next({ success: 1, data: fireResponse });
                    }
                    catch (ex) {
                        console.log(ex);
    ...
    // Utils for exam_live_students
    examLiveStudents_student_subscribe(examHashId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForStudentExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var unsubscriber = this.myOnSnapshot(response.data, 'exam_live_students/' + examHashId, this.getUserId(), (fireResponse) => {
                            subscriber.next({ success: 1, data: fireResponse });
                        });
                        this.addUnsubscribe('exam_live_students_' + examHashId, unsubscriber);
                    }
                    catch (ex) {
                        console.log(ex);
                        subscriber.next({ success: 0, message: 'EXCEPTION', ex: ex.toString() });
    ...
    examLiveStudents_student_unbsubscribe(examHashId) {
        this.removeAllunsubscribe('exam_live_students_' + examHashId);
    }
    examLiveStudents_teacher_subscribe(examHashId, userId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForTeacherExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var unsubscriber = this.myOnSnapshot(response.data, 'exam_live_students/' + examHashId, userId, (fireResponse) => {
                            subscriber.next({ success: 1, data: fireResponse });
                        });
                        this.addUnsubscribe('exam_live_students_' + examHashId, unsubscriber);
                    }
    ...
    examLiveStudents_teacher_unbsubscribe(examHashId) {
        this.removeAllunsubscribe('exam_live_students_' + examHashId);
    }
    examLiveStudents_student_saveChange(examHashId, dataObj) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForStudentExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var fireResponse = yield this._saveDocument(response.data, 'exam_live_students/' + examHashId, this.getUserId(), dataObj);
                        subscriber.next({ success: 1, data: fireResponse });
                    }
                    catch (ex) {
                        console.log(ex);
    ...
    examLiveStudents_teacher_saveChange(examHashId, userId, dataObj) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            this.getFirestoreDbForTeacherExam(false, examHashId).subscribe((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
                if (response && response.success == 1) {
                    try {
                        var fireResponse = yield this._saveDocumentMerge(response.data, 'exam_live_students/' + examHashId, userId, dataObj);
                        subscriber.next({ success: 1, data: fireResponse });
                    }
                    catch (ex) {
                        console.log(ex);
    ...
    // Get firestore db
    getFirestoreDb(getNew) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            var firestoreKey = this.createFirestoreKey('firestore_db');
            var curDb = this.getLocalFirestoreDb(firestoreKey);
            if (curDb != undefined && getNew == false) {
                var returnObj = { success: 1, data: curDb, message: 'successful' };
                subscriber.next(returnObj);
                subscriber.complete();
            }
            else {
                this.firestoreServiceApi.apiFirestoreGetSimpleTokenGet().subscribe((response) => {
                    var _a, _b, _c;
                    if (response && response.success == 1) {
                        (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.signInWithCustomToken)((0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.getAuth)(), (_b = (_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.token) !== null && _b !== void 0 ? _b : '').then(() => {
                            var db = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.getFirestore)(this.app);
                            this.setLocalFirestoreDb(firestoreKey, db);
                            var returnObj1 = { success: 1, data: db, message: 'successful' };
                            subscriber.next(returnObj1);
                            subscriber.complete();
                        }).catch((error) => {
                            if (error.code === 'auth/invalid-custom-token') { // login expired;
                                var returnObj2 = { success: 0, data: undefined, message: 'EXPIRED' };
                                subscriber.next(returnObj2);
                                subscriber.complete();
                            }
                            else { // authen error
                                var returnObj3 = { success: 0, data: undefined, message: 'AUTH_ERROR' };
                                subscriber.next(returnObj3);
                                subscriber.complete();
                            }
                        });
                        ...
                        var returnObj4 = { success: 0, data: undefined, message: (_c = response.message) !== null && _c !== void 0 ? _c : '' };
                        subscriber.next(returnObj4);
                        subscriber.complete();
                    }
                });
            }
    ...
    getFirestoreDbForStudentExam(getNew, hashId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            var firestoreKey = this.createFirestoreKey('firestore_db_student_' + hashId);
            var curDb = this.getLocalFirestoreDb(firestoreKey);
            if (curDb != undefined && getNew == false) {
                var returnObj = { success: 1, data: curDb, message: 'successful' };
                subscriber.next(returnObj);
                ...
                this.firestoreServiceApi.apiFirestoreGetStudentExamTokenGet(hashId).subscribe((response) => {
                    var _a, _b, _c;
                    if (response && response.success == 1) {
                        (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.signInWithCustomToken)((0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.getAuth)(), (_b = (_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.token) !== null && _b !== void 0 ? _b : '').then(() => {
                            var db = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.getFirestore)(this.app);
    ...
    getFirestoreDbForTeacherExam(getNew, hashId) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            var firestoreKey = this.createFirestoreKey('firestore_db_teacher_' + hashId);
            var curDb = this.getLocalFirestoreDb(firestoreKey);
            if (curDb != null && getNew == false) {
                var returnObj = { success: 1, data: curDb, message: 'successful' };
                subscriber.next(returnObj);
                subscriber.complete();
            }
            else {
                this.firestoreServiceApi.apiFirestoreGetTeacherExamTokenGet(hashId).subscribe((response) => {
                    var _a, _b, _c;
                    if (response && response.success == 1) {
                        (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.signInWithCustomToken)((0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.getAuth)(), (_b = (_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.token) !== null && _b !== void 0 ? _b : '').then(() => {
                            var db = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.getFirestore)(this.app);
    ...
    signInUserByToken(token) {
        return new rxjs__WEBPACK_IMPORTED_MODULE_6__.Observable((subscriber) => {
            (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.signInWithCustomToken)((0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.getAuth)(), token).then(() => {
                var returnObj = { success: 1, data: '', message: 'successful' };
                subscriber.next(returnObj);
                subscriber.complete();
            }).catch((error) => {
                if (error.code === 'auth/invalid-custom-token') { // login expired;
                    var returnObj = { success: 0, data: '', message: 'EXPIRED' };
                    subscriber.next(returnObj);
                    subscriber.complete();
                }
                else { // authen error
                    var returnObj = { success: 0, data: '', message: 'AUTH_ERROR' };
                    subscriber.next(returnObj);
                    subscriber.complete();
                }
            });
    ...
    // Get firestore db utils
    setLocalFirestoreDb(firestoreKey, db) {
        this.firestoreDbs[firestoreKey] = db;
    }
    getLocalFirestoreDb(firestoreKey) {
        if (this.firestoreDbs.hasOwnProperty(firestoreKey)) {
            return this.firestoreDbs[firestoreKey];
        }
        else {
            return undefined;
        }
    }
    removeLocalFirestoreDb(firestoreKey) {
        if (this.firestoreDbs.hasOwnProperty(firestoreKey)) {
            delete this.firestoreDbs[firestoreKey];
        }
    }
    createFirestoreKey(slug) {
        return this.userService.getUserObj().id + '_' + slug;
    }
    getUserId() {
        var _a, _b;
        return (_b = (_a = this.userService.getUserObj().id) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '0';
    }
    // Utils to unbsubscribe
    addUnsubscribe(sub_key, sub) {
        sub_key = this.getUserId() + '_' + sub_key;
        if (!this.listSubscribers.hasOwnProperty(sub_key)) {
            this.listSubscribers[sub_key] = [];
        }
        this.listSubscribers[sub_key].push(sub);
    }
    removeAllunsubscribe(sub_key) {
        sub_key = this.getUserId() + '_' + sub_key;
        if (this.listSubscribers.hasOwnProperty(sub_key)) {
            for (var i = 0; i < this.listSubscribers[sub_key].length; i++) {
                this.listSubscribers[sub_key][i]();
            }
            delete this.listSubscribers[sub_key];
        }
    }
    // Firestore utils
    _saveDocument(db, collection_path, document_name, obj) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            collection_path = this.getBaseFirestore() + '/' + collection_path;
            yield (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.setDoc)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.doc)(db, collection_path, document_name), JSON.parse(JSON.stringify(obj)));
            return document_name;
        });
    }
    _saveDocumentMerge(db, collection_path, document_name, obj) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            collection_path = this.getBaseFirestore() + '/' + collection_path;
            yield (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.setDoc)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.doc)(db, collection_path, document_name), JSON.parse(JSON.stringify(obj)), { merge: true });
            return document_name;
        });
    }
    _getCollection(db, collection_path) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            collection_path = this.getBaseFirestore() + '/' + collection_path;
            const colObj = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.collection)(db, collection_path);
            const docSnapshot = yield (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.getDocs)(colObj);
            const all_docs = docSnapshot.docs.map(doc => doc.data());
            return all_docs;
        });
    }
    _getDocument(db, collection_path, document_name) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            collection_path = this.getBaseFirestore() + '/' + collection_path;
            const docRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.doc)(db, collection_path, document_name);
    ...
    _getDocuments(db, collection_path, document_names) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            var returnObj = {};
            collection_path = this.getBaseFirestore() + '/' + collection_path;
            const q = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.query)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.collection)(db, collection_path), (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.where)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.documentId)(), 'in', document_names));
    ...
    _removeDocument(db, collection_path, document_name) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            collection_path = this.getBaseFirestore() + '/' + collection_path;
            yield (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.deleteDoc)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.doc)(db, collection_path, document_name));
        });
    }
    // Firestore listen
    myOnSnapshot(db, collection_path, document_name, callback) {
        collection_path = this.getBaseFirestore() + '/' + collection_path;
        var unsubscribe = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.onSnapshot)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.doc)(db, collection_path, document_name), (docData) => {
            callback(docData.data());
        });
        return unsubscribe;
    }
    myOnSnapshotCollection(db, collection_path, callback) {
        collection_path = this.getBaseFirestore() + '/' + collection_path;
        const unsubscribe = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.onSnapshot)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.collection)(db, collection_path), (docSnapshot) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            var all_docs = [];
    ...
    myOnSnapshotOnlyChangeInCollection(db, collection_path, callback) {
        collection_path = this.getBaseFirestore() + '/' + collection_path;
        const unsubscribe = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.onSnapshot)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.collection)(db, collection_path), (docSnapshot) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            var all_docs = [];
            docSnapshot.docChanges().forEach((change) => {
                all_docs.push(change.doc.data());
            });
            callback(all_docs);
        }));
        return unsubscribe;
    }
    myOnSnapshotCollectionWithQuery(db, collection_path, queryParams, callback) {
        collection_path = this.getBaseFirestore() + '/' + collection_path;
        const q = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.query)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.collection)(db, collection_path), (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.where)(queryParams[0], queryParams[1], queryParams[2]));
        const unsubscribe = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.onSnapshot)(q, (docSnapshot) => (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            var all_docs = [];
            docSnapshot.docChanges().forEach((change) => {
                all_docs.push(change.doc.data());
            });
    ...
    // Common Firestore utils
    getBaseFirestore() {
        return src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.firestoreBase;
    }
    getInitApp() {
        return this.app;
    }
}
FirestoreService.ɵfac = function FirestoreService_Factory(t) { return new (t || FirestoreService)(_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](src_app_core_auto_api_common_api_api_firestore_service__WEBPACK_IMPORTED_MODULE_4__.FirestoreService), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_user_service__WEBPACK_IMPORTED_MODULE_5__.UserService)); };
...
/* harmony export */   "writeBatch": () => (/* reexport safe */ _firebase_firestore__WEBPACK_IMPORTED_MODULE_0__.writeBatch)
/* harmony export */ });
/* harmony import */ var _firebase_firestore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/firestore */ 8505);
